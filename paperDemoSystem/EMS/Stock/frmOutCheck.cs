...
namespace EMS.Stock
{
    public partial class frmOutCheck : Form
    {
        ...
        private void frmOutCheck_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dgvList.Columns[0].HeaderText = "出库编号";
                ...
                dgvList.Columns[3].HeaderText = "出库日期";
