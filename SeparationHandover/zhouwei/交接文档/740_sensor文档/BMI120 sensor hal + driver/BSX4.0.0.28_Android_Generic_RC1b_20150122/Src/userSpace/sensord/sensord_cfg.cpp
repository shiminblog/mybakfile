...
#define ALSH_RDFIFO_NAME	"alsh_read_fifo"
#define ALGOPASS_NAME       "algo_pass"
#define DATA_LOG_NAME		"data_log_enable"
#define SENSORS_MASK_NAME  "sensors_mask"
#define ALSH_SYS_RECOVERY_NAME	"alsh_sys_recovery"
#define ALSH_INTR_PIN_NAME	"alsh_intr_pin"
...
int algo_pass = 0;
int alsh_read_fifo = 1;
int alsh_sys_recovery = 0;
int alsh_intr_pin = 0;
int data_log = 0;
...
#define MATCH(s, n) strcmp(section, s) == 0 && strcmp(name, n) == 0
    ...
    else if (MATCH(DEBUG_SEC, ALSH_RDFIFO_NAME))
    {
        alsh_read_fifo = atoi(value);
    }
    ...
    else if (MATCH(DEBUG_SEC, ALSH_SYS_RECOVERY_NAME))
    {
        alsh_sys_recovery = atoi(value);
    }
    else if (MATCH(DEBUG_SEC, ALSH_INTR_PIN_NAME))
    {
        alsh_intr_pin = atoi(value);
    }
