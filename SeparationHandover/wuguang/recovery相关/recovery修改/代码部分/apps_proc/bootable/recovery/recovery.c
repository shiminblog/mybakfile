...
#ifndef ENABLE_RECOVERY_COMMAND_LINE_ARG
#define ENABLE_RECOVERY_COMMAND_LINE_ARG
...
main(int argc, char **argv) {
    ...
    //freopen(TEMPORARY_LOG_FILE, "a", stdout); //eason del
    //freopen(TEMPORARY_LOG_FILE, "a", stderr); //eason del
    ...
    if (update_package != NULL) {
        //status = install_package(update_package, &wipe_cache, TEMPORARY_INSTALL_FILE); //eason del
        status = install_package(update_package, &wipe_cache, stdout); //eason add
...
#endif /*ENABLE_RECOVERY_COMMAND_LINE_ARG*/
